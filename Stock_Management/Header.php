...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Stock Managent System</title>
	...
	<header class="ttr-header">
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-header-right ttr-with-seperator">
				...
				<a onclick="Logout()"><h2 style="margin-top:15px; margin-right:10px; color:white"><i class="fa-solid fa-right-from-bracket"></i></h2></a>
				</ul>
